...
export default defineType({name:'project',title:'Project',type:'document',fields:[
  ...
  defineField({name:'category',title:'Category',type:'string',options:{list:['Brand Identity','Corporate Communications','Packaging & Regulatory Design','Exhibition & Event Branding','Editorial Design','Publication Design','Web & UI Design','Corporate Video','AI-Assisted Creative']},validation:R=>R.required()}),
